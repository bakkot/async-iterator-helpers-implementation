// Check the ANIMATIONS against the implementation: run the scenario-converted
// animations (generated by async-iterator-animations/scenarios/
// convert-animations.js) as tests. A failure here means the story an
// animation tells differs from what the implementation actually does — either
// a real disagreement, or (expected, to be hand-corrected in the scenario
// files) a same-tick event order the animation never specified.
